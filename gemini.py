...
summary_model = get_model("""
    Extract and summarize the key ideas from the input text.
    Focus on:
...
st.write("Enter text below to generate a summary using Gemini AI")
...
# Write Post button
if col2.button("Write Post"):
    if user_input:
        with st.spinner("Writing viral post..."):
        ...
        st.warning("Please enter some text to create a post.")

# Write Essay button
if col3.button("Write Essay"):
    if user_input:
        ...
        st.warning("Please enter some text to create an essay.")
